	...
	namespace Module {
		...
		namespace Front { //front
			namespace Left {
				...
				static constexpr units::turn_t MagnetOffset = 0.988281_tr;
			...
			namespace Right {
				...
				static constexpr units::turn_t MagnetOffset = 0.438965_tr;
		...
		namespace Rear { 
			namespace Left {
				...
				static constexpr units::turn_t MagnetOffset = 0.082031_tr;
			...
			namespace Right {
				...
				static constexpr units::turn_t MagnetOffset = 0.533936_tr;
