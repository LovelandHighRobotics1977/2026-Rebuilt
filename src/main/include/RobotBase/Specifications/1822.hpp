	...
	namespace Module {
		...
		namespace Front { //front
			...
			namespace Right {
				...
				static constexpr units::turn_t MagnetOffset = 0.91626_tr;
		...
		namespace Rear { 
			namespace Left {
				...
				static constexpr units::turn_t MagnetOffset = 0.913086_tr;
			...
			namespace Right {
				...
				static constexpr units::turn_t MagnetOffset = 0.048584_tr;
